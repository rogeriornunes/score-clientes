package br.com.gerenciamento.scoreclientes.insfrastructure.filter;
...
public class FilterTokensJWT extends GenericFilterBean {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			Jwts.parser().setSigningKey("wdsjfhkwbfdgwuierhweij").parseClaimsJws(token).getBody();
