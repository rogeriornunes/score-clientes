...
public class JWTServiceImpl implements JWTService {
	...
	@Override
	public TokenResponse autenticar(UsuarioRequest usuarioRequest) {
		if (!usuarioService.validarUsuarioSenha(usuarioRequest)) {
		...
		String token = gerarToken(usuarioRequest.getEmail());
